<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\wamp64\www\hlcfc\public/../application/admin\view\typelist\index.html";i:1526973088;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <?php if(is_array($vo['params']) || $vo['params'] instanceof \think\Collection || $vo['params'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['params'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vi): $mod = ($i % 2 );++$i;?>
        ...
        <a href="/hlcfc/public/admin/TypeList/delType?id=<?php echo $vi['id']; ?>">删除</a><br/>
    ...
    <a href="/hlcfc/public/admin/TypeList/delType?typeid=<?php echo $vo['typeid']; ?>">删除</a><br/>
    <?php endforeach; endif; else: echo "" ;endif; ?>
</body>
</html>